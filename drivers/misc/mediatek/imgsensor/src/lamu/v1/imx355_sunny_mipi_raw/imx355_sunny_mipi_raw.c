				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CROP_INFO:
		pr_debug("SENSOR_FEATURE_GET_CROP_INFO scenarioId:%u\n",
			(unsigned int)(UINT16) *feature_data);
	...
	case SENSOR_FEATURE_SET_HDR_SHUTTER:
		LOG_INF("SENSOR_FEATURE_SET_HDR_SHUTTER LE=%u, SE=%u\n",
			(unsigned int)(UINT16)*feature_data,
			(unsigned int)(UINT16)*(feature_data+1));
		#if 0
