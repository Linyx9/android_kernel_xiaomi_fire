...
#include "sc820cs_truly_mipi_raw.h"
...
#define SC820CS_SENSOR_MAX_GAIN            (635 * SC820CS_SENSOR_BASE_GAIN /10)
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC820CS_TRULY_SENSOR_ID,
...
static void set_max_framerate(UINT16 framerate, kal_bool min_framelength_en)
{
	...
	LOG_INF("framerate = %u, min framelength should enable? %d\n",
		(unsigned int)framerate, min_framelength_en);
